...
for i in range(exec_number):
	...
	total_down_time.append(sim.average_down_time)
	...
	#print("DOWN TIME",sim.average_down_time)
	#print("AVG PROC", sim.average_rrhs_processing_time)
	util.resetParams()
...
for i in range(exec_number):
	...
	total_down_time2.append(sim.average_down_time)
...
for i in range(exec_number):
	...
	total_down_time3.append(sim.average_down_time)
...
for i in range(exec_number):
	...
	total_down_time4.append(sim.average_down_time)
...
plt.grid()
plt.savefig('/home/tinini/Área de Trabalho/gc19/min_Redir/service_availability{}.png'.format(number_of_rrhs), bbox_inches='tight')
#plt.show()
plt.clf()
...
plt.legend(loc="upper left",prop={'size': 8})
plt.grid()
plt.savefig('/home/tinini/Área de Trabalho/gc19/min_Redir/lambda_usage{}.png'.format(number_of_rrhs), bbox_inches='tight')
#plt.show()
plt.clf()
...
plt.legend(loc="upper left",prop={'size': 8})
plt.grid()
plt.savefig('/home/tinini/Área de Trabalho/gc19/min_Redir/procs_usage{}.png'.format(number_of_rrhs), bbox_inches='tight')
#plt.show()
plt.clf()
...
plt.grid()
plt.savefig('/home/tinini/Área de Trabalho/gc19/min_Redir/migrations{}.png'.format(number_of_rrhs), bbox_inches='tight')
#plt.show()
plt.clf()
...
plt.legend(loc="upper left",prop={'size': 6})
plt.grid()
plt.savefig('/home/tinini/Área de Trabalho/gc19/min_Redir/power{}.png'.format(number_of_rrhs), bbox_inches='tight')
#plt.show()
plt.clf()
...
plt.legend(loc="upper left",prop={'size': 6})
plt.grid()
plt.savefig('/home/tinini/Área de Trabalho/gc19/min_Redir/nodes{}.png'.format(number_of_rrhs), bbox_inches='tight')
#plt.show()
plt.clf()
...
plt.legend(loc="upper left",prop={'size': 6})
plt.grid()
plt.savefig('/home/tinini/Área de Trabalho/gc19/min_Redir/dus{}.png'.format(number_of_rrhs), bbox_inches='tight')
#plt.show()
plt.clf()
...
plt.legend(loc="upper left",prop={'size': 6})
plt.grid()
plt.savefig('/home/tinini/Área de Trabalho/gc19/min_Redir/lambdas{}.png'.format(number_of_rrhs), bbox_inches='tight')
#plt.show()
plt.clf()
...
plt.legend(loc="upper left",prop={'size': 6})
plt.grid()
plt.savefig('/home/tinini/Área de Trabalho/gc19/min_Redir/redirected{}.png'.format(number_of_rrhs), bbox_inches='tight')
#plt.show()
plt.clf()
...
plt.legend(loc="upper left",prop={'size': 6})
plt.grid()
plt.savefig('/home/tinini/Área de Trabalho/gc19/min_Redir/switches{}.png'.format(number_of_rrhs), bbox_inches='tight')
#plt.show()
plt.clf()
...
plt.legend(loc="upper left",prop={'size': 6})
plt.grid()
plt.savefig('/home/tinini/Área de Trabalho/gc19/min_Redir/blocked{}.png'.format(number_of_rrhs), bbox_inches='tight')
#plt.show()
plt.clf()
...
plt.legend(loc="upper left",prop={'size': 6})
plt.grid()
plt.savefig('/home/tinini/Área de Trabalho/gc19/min_Redir/solution_time{}.png'.format(number_of_rrhs), bbox_inches='tight')
#plt.show()
plt.clf()
...
with open('/home/tinini/Área de Trabalho/gc19/min_Redir/logs/down_time_live_migration{}.txt'.format(number_of_rrhs),'w') as filehandle:  
...
with open('/home/tinini/Área de Trabalho/gc19/min_Redir/logs/down_time_probability_live_migration{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("LoadInc Threshold {}\n\n".format(old_th))
...
with open('/home/tinini/Área de Trabalho/gc19/min_Redir/logs/migration_time_live_migration{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("LoadInc Threshold {}\n\n".format(old_th))
    ...
    filehandle.write("\n")
#power consumption
with open('/home/tinini/Área de Trabalho/gc19/min_Redir/logs/power_consumption{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    ...
    filehandle.write("\n")
#lambda usage
with open('/home/tinini/Área de Trabalho/gc19/min_Redir/logs/lambda_usage{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
#proc usage
with open('/home/tinini/Área de Trabalho/gc19/min_Redir/logs/dus_usage{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
#external migrations
with open('/home/tinini/Área de Trabalho/gc19/min_Redir/logs/external_migrations{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
#active nodes
with open('/home/tinini/Área de Trabalho/gc19/min_Redir/logs/avg_activated_nodes{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
#active lambdas
with open('/home/tinini/Área de Trabalho/gc19/min_Redir/logs/avg_activated_lambdas{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
with open('/home/tinini/Área de Trabalho/gc19/min_Redir/logs/avg_redirected{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
#active switches
with open('/home/tinini/Área de Trabalho/gc19/min_Redir/logs/avg_activated_switches{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
#blocked RRHs
with open('/home/tinini/Área de Trabalho/gc19/min_Redir/logs/avg_blocked{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
with open('/home/tinini/Área de Trabalho/gc19/min_Redir/logs/avg_solution_time{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
with open('/home/tinini/Área de Trabalho/gc19/min_Redir/logs/avg_cloud_use{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
with open('/home/tinini/Área de Trabalho/gc19/min_Redir/logs/avg_fog_use{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
with open('/home/tinini/Área de Trabalho/gc19/min_Redir/logs/amount_external_migrations{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
with open('/home/tinini/Área de Trabalho/gc19/min_Redir/logs/amount_served_rrhs{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")
...
with open('/home/tinini/Área de Trabalho/gc19/min_Redir/logs/requested_rrhs{}.txt'.format(number_of_rrhs),'w') as filehandle:  
    filehandle.write("Batch\n\n")

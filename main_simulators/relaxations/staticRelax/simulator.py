...
#import relaxAlgs as ra #commenting this line only to be able to call simulator module without mutual import in relaxAls
...
class Util(object):
	...
	def createRRHs(self, amount, nodes_matrix, env, service_time, cp):
		#rrhs = []

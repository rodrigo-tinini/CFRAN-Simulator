...
plt.grid()
plt.savefig('/home/hextinini/Área de Trabalho/simulador/CFRAN-Simulator/graphs/plots/power{}_remove_ff.png'.format(g.rrhs_amount), bbox_inches='tight')
#plt.show()
plt.clf()
...
plt.legend(loc="upper left",prop={'size': 6})
plt.grid()
plt.savefig('/home/hextinini/Área de Trabalho/simulador/CFRAN-Simulator/graphs/plots/blocking{}__remove_ff.png'.format(g.rrhs_amount), bbox_inches='tight')
#plt.show()
plt.clf()
...
plt.legend(loc="upper left",prop={'size': 6})
plt.grid()
plt.savefig('/home/hextinini/Área de Trabalho/simulador/CFRAN-Simulator/graphs/plots/execution_time{}__remove_ff.png'.format(g.rrhs_amount), bbox_inches='tight')
#plt.show()
plt.clf()
...
plt.legend(loc="upper left",prop={'size': 6})
plt.grid()
plt.savefig('/home/hextinini/Área de Trabalho/simulador/CFRAN-Simulator/graphs/plots/blocking_probability{}_remove_ff.png'.format(g.rrhs_amount), bbox_inches='tight')
#plt.show()
plt.clf()
'''
resetMarkers()
...
plt.legend(loc="upper left",prop={'size': 6})
plt.grid()
plt.savefig('/home/hextinini/Área de Trabalho/simulador/CFRAN-Simulator/graphs/plots/power{}_remove_cf.png'.format(g.rrhs_amount), bbox_inches='tight')
#plt.show()
plt.clf()
...
plt.legend(loc="upper left",prop={'size': 6})
plt.grid()
plt.savefig('/home/hextinini/Área de Trabalho/simulador/CFRAN-Simulator/graphs/plots/blocking{}_remove_cf.png'.format(g.rrhs_amount), bbox_inches='tight')
#plt.show()
plt.clf()
...
plt.legend(loc="upper left",prop={'size': 6})
plt.grid()
plt.savefig('/home/hextinini/Área de Trabalho/simulador/CFRAN-Simulator/graphs/plots/execution_time{}__remove_cf.png'.format(g.rrhs_amount), bbox_inches='tight')
#plt.show()
plt.clf()
...
plt.legend(loc="upper left",prop={'size': 6})
plt.grid()
plt.savefig('/home/hextinini/Área de Trabalho/simulador/CFRAN-Simulator/graphs/plots/blocking_probability{}_remove_cf.png'.format(g.rrhs_amount), bbox_inches='tight')
#plt.show()
plt.clf()
...
plt.legend(loc="upper left",prop={'size': 6})
plt.grid()
plt.savefig('/home/hextinini/Área de Trabalho/simulador/CFRAN-Simulator/graphs/plots/power{}_remove_random.png'.format(g.rrhs_amount), bbox_inches='tight')
#plt.show()
plt.clf()
...
plt.legend(loc="upper left",prop={'size': 6})
plt.grid()
plt.savefig('/home/hextinini/Área de Trabalho/simulador/CFRAN-Simulator/graphs/plots/blocking{}_remove_random.png'.format(g.rrhs_amount), bbox_inches='tight')
#plt.show()
plt.clf()
...
plt.legend(loc="upper left",prop={'size': 6})
plt.grid()
plt.savefig('/home/hextinini/Área de Trabalho/simulador/CFRAN-Simulator/graphs/plots/execution_time{}__remove_random.png'.format(g.rrhs_amount), bbox_inches='tight')
#plt.show()
plt.clf()
...
plt.legend(loc="upper left",prop={'size': 6})
plt.grid()
plt.savefig('/home/hextinini/Área de Trabalho/simulador/CFRAN-Simulator/graphs/plots/blocking_probability{}_remove_random.png'.format(g.rrhs_amount), bbox_inches='tight')
#plt.show()
plt.clf()

print(total_power_mean)
print(total_blocking_mean)
...
def genLogs(removeHeuristic):
	...
	for i in sched_pol:
		#power consumption
		with open('/home/hextinini/Área de Trabalho/simulador/CFRAN-Simulator/graphs/logs/power_consumption_{}_{}_{}.txt'.format(i,removeHeuristic, g.rrhs_amount),'a') as filehandle:  
		    filehandle.write("{}\n\n".format(i))
		    filehandle.writelines("%s\n" % p for p in total_power_mean["{}".format(i)])
		    filehandle.write("\n")
		    filehandle.write("\n")
		#blocked
		with open('/home/hextinini/Área de Trabalho/simulador/CFRAN-Simulator/graphs/logs/blocked_{}_{}_{}.txt'.format(i,removeHeuristic, g.rrhs_amount),'a') as filehandle:  
		    filehandle.write("{}\n\n".format(i))
		    filehandle.writelines("%s\n" % p for p in total_blocking_mean["{}".format(i)])
		    filehandle.write("\n")
		    filehandle.write("\n")
	    #blocking probability
		with open('/home/hextinini/Área de Trabalho/simulador/CFRAN-Simulator/graphs/logs/blocking_probability_{}_{}_{}.txt'.format(i,removeHeuristic, g.rrhs_amount),'a') as filehandle:  
		    filehandle.write("{}\n\n".format(i))
		    filehandle.writelines("%s\n" % p for p in total_blocking_prob_mean["{}".format(i)])
		    filehandle.write("\n")
		    filehandle.write("\n")
		#execution times
		with open('/home/hextinini/Área de Trabalho/simulador/CFRAN-Simulator/graphs/logs/exec_times_{}_{}_{}.txt'.format(i,removeHeuristic, g.rrhs_amount),'a') as filehandle:  
		    filehandle.write("{}\n\n".format(i))
